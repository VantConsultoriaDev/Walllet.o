    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 h-full flex flex-col">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
                <TabsList className="w-full justify-start h-12 bg-muted/20 p-1 shrink-0">
                ...
                <TabsContent value="geral" className="flex-1 mt-6 overflow-y-auto">
            ...
            <NewVehicleModal
                ...
                onDelete={onDeleteVehicle} // <-- Passando a função de exclusão
